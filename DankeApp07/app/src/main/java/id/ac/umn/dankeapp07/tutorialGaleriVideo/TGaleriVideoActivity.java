package id.ac.umn.dankeapp07.tutorialGaleriVideo;
...
public class TGaleriVideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_t_galeri_video);

        this.setTitle("W07_33276 (Galeri Video)");
